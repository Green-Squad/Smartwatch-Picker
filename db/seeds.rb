...
smartwatches = [{name: 'LG G Watch', battery_life: 1, engadget_score: 68, release_date: Date.new(2014, 6, 25), image_path: '',
                ...
                {name: 'Samsung Gear Live', battery_life: 1, engadget_score: 73, release_date: Date.new(2014, 6, 25), image_path: '',
                ...
                {name: 'Moto 360', battery_life: 1, engadget_score: 76, release_date: Date.new(2014, 9, 5), image_path: '',
                ...
                {name: 'LG G Watch R', battery_life: 1, engadget_score: 76, release_date: Date.new(2014, 11, 5), image_path: '',
                ...
                {name: 'ASUS ZenWatch', battery_life: 1, engadget_score: 75, release_date: Date.new(2014, 11, 9), image_path: '',
                ...
                {name: 'Sony SmartWatch 3', battery_life: 2, engadget_score: 76, release_date: Date.new(2014, 11, 10), image_path: '',
                ...
                {name: 'Pebble', battery_life: 7, engadget_score: 80, release_date: Date.new(2013, 1, 23), image_path: '',
                ...
                {name: 'Pebble Steel', battery_life: 7, engadget_score: 85, release_date: Date.new(2014, 1, 28), image_path: '',
                ...
                {name: 'Samsung Gear 2', battery_life: 3, engadget_score: 71, release_date: Date.new(2014, 4, 11), image_path: '',
                ...
                {name: 'Samsung Gear 2 Neo', battery_life: 3, engadget_score: 72, release_date: Date.new(2014, 4, 11), image_path: '',
                ...
                {name: 'Samsung Gear S', battery_life: 2, engadget_score: 65, release_date: Date.new(2014, 11, 7), image_path: '',
