...
ActiveRecord::Schema.define(version: 20150421180254) do
  ...
  create_table "log_keepers", force: :cascade do |t|
    t.string   "ip_address"
  ...
  add_index "log_keepers", ["phone_os_id"], name: "index_log_keepers_on_phone_os_id", using: :btree
  ...
  create_table "smartwatches", force: :cascade do |t|
    t.string   "name"
    t.float    "battery_life"
    t.float    "price"
    t.date     "release_date"
